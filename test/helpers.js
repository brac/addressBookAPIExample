...
const groupMembershipFixtures     = require('./fixtures/group_members.json')
...
function insertGroupMembershipsFixtures() {
  return Promise.all(
    groupMembershipFixtures.map((membership) => sql.createMembership(membership))
  )
}
...
function resetDatabase() {
  return clearDatabase()
    ...
    .then(insertGroupMembershipsFixtures)
    .catch(console.error)
}
...
module.exports = {
  ...
  insertGroupMembershipsFixtures,
  resetDatabase,
}